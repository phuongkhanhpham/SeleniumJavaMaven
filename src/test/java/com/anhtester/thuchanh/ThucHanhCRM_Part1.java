...
public class ThucHanhCRM_Part1 extends BaseTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath(LocatorCRM.inputCompany)).sendKeys("VNPT IT Ha Noi 050625002");
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath(LocatorCRM.menuCustomer)).click();
        driver.findElement(By.xpath(LocatorCRM.searchCustomer)).sendKeys("VNPT IT Ha Noi 050625002");
        Thread.sleep(2000);
