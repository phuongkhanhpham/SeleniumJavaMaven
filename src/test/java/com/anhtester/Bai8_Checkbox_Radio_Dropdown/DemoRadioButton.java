...
public class DemoRadioButton extends BaseTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath(LocatorCRM.menuProposals)).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath(LocatorCRM.buttonNewProposal)).click();
        Thread.sleep(2000);
        ...
        //Nếu chưa được check thì click vào radio button đó
//        if (isSelected == false) {
